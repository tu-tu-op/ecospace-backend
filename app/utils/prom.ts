...
*ðŸ” Problems Found*: [Number of actual issues]
...
- âš ï¸ Minor issues - can deploy with fixes
- âŒ Critical issues - must fix before deploy
...
*âœ… Status*: âš ï¸ Minor issues - can deploy with fixes
